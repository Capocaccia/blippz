...
class EmailController extends Controller
{
    public function sendCreatorEmail($blipId, $recipient)
    {
        ...
        $email->addContent(
            "text/html", "Hello " . $recipient->firstName . "! I hope you had fun on your outing.  Please click the link below to indicate you are safe.  If you do not click the link within 3 hours, your Blip contacts will be notified. <br/><br/> <a href='www.blippz.com/#/markSafe/$blipId'>Click here to tell Blippz you are safe!</a>"
        );
